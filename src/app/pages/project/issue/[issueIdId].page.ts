...
import { IssueDetailComponent } from '../_components/issues/issue-detail/issue-detail.component';
...
@UntilDestroy()
export default class FullIssueDetailComponent implements OnInit {
